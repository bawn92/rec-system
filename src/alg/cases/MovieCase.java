...
public class MovieCase implements Case
{
	...
	public MovieCase(final Integer id, final String title, final ArrayList<String> genres, final ArrayList<String> directors, final ArrayList<String> actors, final Double mean, final Double pop)
	{
		this(id);
		this.title = title;
